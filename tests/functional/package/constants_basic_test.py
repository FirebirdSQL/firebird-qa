...
TITLE:       Package constants (#8916) - basic test.
DESCRIPTION:
...
NOTES:
    ...
    [28.05.2026] pzotov
    Moved into new location + renamed, previous name: bugs/gh_8916_test.py
    Additional check on 6.0.0.1971-0-79b12a6 after commits ee3e78b8 and 5d04fe75.
"""
