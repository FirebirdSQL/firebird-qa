#coding:utf-8
#
# id:           functional.fkey.unique.insert_01
# title:        Check correct work fix with foreign key
# decription:   Check foreign key work.
#               Master table has one primary key field and one unique field. Master transaction doesn't modify primary key or unique field.
#               Detail transaction inserts record in detail_table.
#               Expected: no errors
# tracker_id:   
# min_versions: []
# versions:     2.5
# qmid:         functional.fkey.unique.ins_01
