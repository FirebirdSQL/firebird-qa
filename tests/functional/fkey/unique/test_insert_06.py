#coding:utf-8
#
# id:           functional.fkey.unique.insert_06
...
# min_versions: []
# versions:     2.1
# qmid:         functional.fkey.unique.ins_06
...
#    c = con_detail.cursor()
#    c.execute("INSERT INTO DETAIL_TABLE (ID, FKEY) VALUES (1,null)")
#    con_detail.commit()
#  except Exception, e:
#    print (e[0])
#---
