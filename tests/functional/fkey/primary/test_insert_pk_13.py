...
"""
ID:          fkey.primary.insert-13
FBTEST:      functional.fkey.primary.insert_pk_13
...
def test_1(act: Action):
    ...
    expected_stdout = f"""
        ...
        violation of FOREIGN KEY constraint "FK_TDETL_TMAIN" on table {SQL_SCHEMA_PREFIX}"T_DETL"
