...
"""
ID:          n/a
TITLE:       FK definition: SET DEFAULT clause should not lead FK-columns to have their default values if parent record not yet exists or was removed
DESCRIPTION:
    ...
    Single- and multi-segmented unique keys are checked.
