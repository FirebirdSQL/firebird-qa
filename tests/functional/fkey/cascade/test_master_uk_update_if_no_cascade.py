...
expected_stdout = """
    ...
    REMAINED_MASTER_ID -2000
    REMAINED_MASTER_ID 1000
    REMAINED_MASTER_ID 3000
...
def test_1(act: Action):
    ...
    test_sql = """
        ...
        update tmain set id = -id where id = 1000; -- must FAIL
        update tmain set id = -id where id = 2000; -- must PASS
        update tmain set id = 3000 where id is null; -- must PASS
        ...
        -- must PASS because no detail can refer to the record in master which contain nulls in all key columns:
        update tmain set id1 = 9999, id2 = 9999, id3 = 9999 where coalesce(id1, id2, id3) is null;

        -- Any records in tmain with at least one NOT null value among ID1 ... ID3 must not be updated in following code.
        -- We try to update every row with accumulating count of errors (for appropriate gdscode which must be the same: 335544466).
        ...
        begin
            ...
            do begin
                ...
                update tmain set id1 = null, id2 = null, id3 = null where current of c;
                when any do
                begin
