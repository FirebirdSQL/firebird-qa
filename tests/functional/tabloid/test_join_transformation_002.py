#coding:utf-8
#
# id:           functional.tabloid.join_transformation_002
# title:        Check ability of outer join simplification.
# decription:   Use null-rejected predicate in WHERE filtering leads to replacement of TWO outer joins.
# tracker_id:   
# min_versions: ['3.0']
# versions:     3.0
# qmid:         
...
def test_join_transformation_002_1(act_1: Action):
