...
"""
ID:          functional.tablespace.alter_ts_non_exist
TITLE:       
DESCRIPTION:
FBTEST:      functional.tablespace.alter_ts_non_exist
"""
...
def test_1(act: Action, tmpdir: Path):
    ...
    act.isql(switches=['-q'], input=f"ALTER TABLESPACE TS1 SET FILE '{ts2_file}'; commit;")
