...
"""
ID:          functional.tablespace.autoddl_off.create_table_ts_create_index_ts
TITLE:       
DESCRIPTION:
FBTEST:      functional.tablespace.autoddl_off.create_table_ts_create_index_ts
"""
...
def test_1(act: Action, tmpdir: Path):
    ...
    CREATE INDEX IDX_TEST ON TEST_TABLE (ID) TABLESPACE TS2;
