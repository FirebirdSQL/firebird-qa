...
"""
ID:          functional.tablespace.autoddl_off.create_table_ts_create_index_ts_not_exists
TITLE:       
DESCRIPTION:
FBTEST:      functional.tablespace.autoddl_off.create_table_ts_create_index_ts_not_exists
"""
