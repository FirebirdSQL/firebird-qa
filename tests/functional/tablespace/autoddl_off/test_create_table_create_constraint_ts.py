...
"""
ID:          functional.tablespace.autoddl_off.create_table_create_constraint_ts
TITLE:       
DESCRIPTION:
FBTEST:      functional.tablespace.autoddl_off.create_table_create_constraint_ts
"""
...
def test_1(act: Action, tmpdir: Path):
    ...
    act.isql(switches=['-q', '-n'], input=test_script, combine_output=True)
