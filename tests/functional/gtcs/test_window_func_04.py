#coding:utf-8
#
# id:           functional.gtcs.window_func_04
# title:        GTCS/tests/FB_SQL_WINDOW_FUNC_04 - set of miscelaneous tests for verification of windowed functions.
# decription:   
...
@pytest.mark.xfail
def test_window_func_04_1(db_1):
