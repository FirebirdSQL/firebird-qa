#coding:utf-8
#
# id:           functional.gtcs.gtcs_proc_isql_16
# title:        gtcs-proc-isql-16
# decription:   
#               	Original test see in:
#                       https://github.com/FirebirdSQL/fbtcs/blob/master/GTCS/tests/PROC_ISQL_16.script
...
expected_stdout_1 = """
    ...
    point-2 P15    <null>               Pink         <null> Hoboken
    point-2 P16    <null>               <null>       <null> Varanasi
  """

@pytest.mark.version('>=2.5')
def test_gtcs_proc_isql_16_1(act_1: Action):
