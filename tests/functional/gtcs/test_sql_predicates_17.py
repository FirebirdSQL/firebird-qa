...
"""
ID:          n/a
TITLE:       Check of applying SINGULAR to result produced by a JOIN of two views
DESCRIPTION:
    Original test see in:
    https://github.com/FirebirdSQL/fbtcs/blob/master/GTCS/tests/C_SQL_PRED_17.script
NOTES:
    [29.09.2025] pzotov
