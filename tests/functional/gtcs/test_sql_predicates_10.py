...
"""
ID:          n/a
TITLE:       Check result of DISTINCT when applying SINGULAR to result of query with aggregate function
DESCRIPTION:
    Original test see in:
    https://github.com/FirebirdSQL/fbtcs/blob/master/GTCS/tests/C_SQL_PRED_10.script
NOTES:
    [29.09.2025] pzotov
