...
#                   Checked on:
#                       2.5.9.27126: OK, 0.562s.
#                       3.0.5.33086: OK, 1.641s.
#                       4.0.0.1378: OK, 5.047s.
#                
# tracker_id:   
# min_versions: ['2.5.7']
# versions:     3.0, 4.0
# qmid:         functional.basic.db.db_30
...
expected_stdout_2 = """
    ...
    RDB$FIELD_NAME                  RDB$FIELD_TYPE                                                                                                                                                                                                                                              
    RDB$TYPE                        28
    RDB$TYPE_NAME                   TIME WITH TIMEZONE                                                                                                                                                                                                                                          
    RDB$DESCRIPTION                 <null>
    RDB$SYSTEM_FLAG                 1
    ...
    RDB$FIELD_NAME                  RDB$FIELD_TYPE                                                                                                                                                                                                                                              
    RDB$TYPE                        29
    RDB$TYPE_NAME                   TIMESTAMP WITH TIMEZONE                                                                                                                                                                                                                                     
    RDB$DESCRIPTION                 <null>
    RDB$SYSTEM_FLAG                 1
