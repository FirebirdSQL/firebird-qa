...
"""
ID:          new-database-31
TITLE:       New DB - RDB$USER_PRIVILEGES content
DESCRIPTION: Check the correct content of RDB$USER_PRIVILEGES in new database.
NOTES:
[30.10.2015]
...
expected_stdout_3 = """
    ...
    RDB$PRIVILEGE                   G
    RDB$GRANT_OPTION                1
    RDB$RELATION_NAME               RDB$KEYWORD_NAME
    RDB$FIELD_NAME                  <null>
    RDB$USER_TYPE                   8
    RDB$OBJECT_TYPE                 9
    ...
    RDB$PRIVILEGE                   G
    RDB$GRANT_OPTION                1
    RDB$RELATION_NAME               RDB$KEYWORD_RESERVED
    RDB$FIELD_NAME                  <null>
    RDB$USER_TYPE                   8
    RDB$OBJECT_TYPE                 9
