...
"""
ID:          replication.generator_could_not_be_transferred_to_replica
ISSUE:       https://github.com/FirebirdSQL/firebird/issues/6848
...
DESCRIPTION:
    ...
    Then we query replica databases and obtain count() for table 'test' and values of sequences G_1 and G_2.
...
def test_1(act_db_main: Action,  act_db_repl: Action, capsys):
    ...
    if out_prep:
        ...
        sql_init = '''    
            ...
            commit;
            insert into test(id) values( gen_id(g_2, 1) );
            update test set id = id + gen_id(g_1, 1);
            commit;
        '''
    ...
    if out_prep:
        ...
        isql_check_script = """
                ...
                select
                    ...
                    ,count(*) as cnt
                    ,gen_id(g_1,0) as g1_curr_val
                    ,gen_id(g_2,0) as g2_curr_val
                from test;
        """
