...
expected_stdout_1 = """
    ...
    TEST_ROWS_ON_MAIN               1
    G1_CURR_VAL_ON_MAIN             1
    G2_CURR_VAL_ON_MAIN             1

    TEST_ROWS_ON_REPL               1
    G1_CURR_VAL_ON_REPL             1
    G2_CURR_VAL_ON_REPL             1
...
#  ### A C H T U N G  ###
#  ######################
#  # MANDATORY, OTHERWISE REPLICATION MAY GET STUCK ON TESTS THAT ARE EXECUTED AFTER THIS
