...
TITLE:       CREATE DOMAIN. Specifying BLOB SUB_TYPE <A>, where A = 'binary' or 'text'.
DESCRIPTION: Domain creation based on BLOB datatype with SUBTYPE <subtype_alias> specification
NOTES:
    [06.10.2023] pzotov
