...
TITLE:       CREATE DOMAIN using 'CHARACTER' keyword
DESCRIPTION: Simple domain creation based on CHARACTER datatype.
NOTES:
    [06.10.2023] pzotov
...
test_script = f"""
    ...
    ;
    commit;
    create domain dm_test CHARACTER({DM_SIZE}) character set win1252 collate win_ptbr;
    commit;
