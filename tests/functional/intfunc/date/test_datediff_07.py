...
test_script_1 = """select datediff(MILLISECOND,cast( '12/02/2008 13:33:33.0001' as timestamp),cast( '12/02/2008 13:33:35.0000' as timestamp)) from rdb$database;
...
def test_datediff_07_1(act_1: Action):
