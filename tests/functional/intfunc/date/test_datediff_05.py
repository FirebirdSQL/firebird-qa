...
test_script_1 = """select datediff(MONTH,cast( '12/02/2008 13:33:33' as timestamp),cast( '12/02/2009 13:34:35' as timestamp)) from rdb$database;
...
def test_datediff_05_1(act_1: Action):
