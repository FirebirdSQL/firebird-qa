...
test_script_1 = """select datediff(MINUTE,cast( '12/02/2008 13:33:33' as timestamp),cast( '12/02/2008 13:34:35' as timestamp)) from rdb$database;
...
def test_datediff_02_1(act_1: Action):
