#coding:utf-8
#
# id:           functional.transactions.read_consist_sttm_restart_on_update_01
...
#      '''  % dict(globals(), **locals())
#  
#      f_worker_sql=open( os.path.join(context['temp_directory'],'tmp_sttm_restart_on_update_01.sql'), 'w')
...
@pytest.mark.xfail
def test_read_consist_sttm_restart_on_update_01_1(db_1):
