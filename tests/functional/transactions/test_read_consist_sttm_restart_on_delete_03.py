#coding:utf-8
#
# id:           functional.transactions.read_consist_sttm_restart_on_delete_03
...
#          set count on;
#  
#          delete from %(target_obj)s where id >= 3 order by id; -- THIS MUST BE LOCKED
#  
#          -- check results:
#          -- ###############
#  
...
@pytest.mark.xfail
def test_read_consist_sttm_restart_on_delete_03_1(db_1):
