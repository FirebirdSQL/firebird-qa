#coding:utf-8
#
# id:           functional.transactions.read_consist_sttm_restart_on_update_04
# title:        READ CONSISTENCY. Check creation of new statement-level snapshot and restarting changed caused by UPDATE. Test-04.
# decription:   
...
#          --set plan on;
#          set count on;
#          update %(target_obj)s set id = -id where id <= 2 order by id DESC rows 4; -- THIS MUST HANG BECAUSE OF LOCKERs
#  
#          -- check results:
#          -- ###############
#  
...
@pytest.mark.xfail
def test_read_consist_sttm_restart_on_update_04_1(db_1):
