...
def test_1(act: Action, capsys):
    ...
    expected_out_4x = f"""
        ...
        ....................-> Table "TABLE_100" as "VA T100" Full Scan
        ................-> Record Buffer (record length: 25)
        ....................-> Table "TABLE_10" as "VA T10" Full Scan
        {data_list[0]}
    """
    ...
    expected_out_6x = f"""
        ...
        ................-> Record Buffer (record length: 25)
        ....................-> Table "PUBLIC"."TABLE_100" as "VA" "T100" Full Scan
        ................-> Record Buffer (record length: 25)
        ....................-> Table "PUBLIC"."TABLE_10" as "VA" "T10" Full Scan
        {data_list[0]}
    """
