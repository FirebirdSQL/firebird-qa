#coding:utf-8
#
# id:           functional.arno.optimizer.opt_sort_by_index_17
# title:        ORDER BY DESC NULLS LAST using index
# decription:   ORDER BY X DESC NULLS LAST
#               When a index can be used for sorting, use it.
# tracker_id:   
# min_versions: []
# versions:     2.0
# qmid:         functional.arno.optimizer.opt_sort_by_index_17
...
def test_opt_sort_by_index_17_1(act_1: Action):
