...
def test_1(act: Action, capsys):
    ...
    expected_out_4x = f"""
        ...
        ............-> Bitmap And
        ................-> Bitmap
        ....................-> Index "I_F2_ASC" Range Scan (full match)
        ................-> Bitmap
        ....................-> Index "I_F1_ASC" Range Scan (upper bound: 1/1)
        {data_list[0]}
    """
    ...
    expected_out_6x = f"""
        ...
        ............-> Bitmap And
        ................-> Bitmap
        ....................-> Index "PUBLIC"."I_F2_ASC" Range Scan (full match)
        ................-> Bitmap
        ....................-> Index "PUBLIC"."I_F1_ASC" Range Scan (upper bound: 1/1)
        {data_list[0]}
    """
