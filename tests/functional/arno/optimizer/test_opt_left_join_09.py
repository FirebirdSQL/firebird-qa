...
qry_list = (
    ...
    SELECT
      ...
      c2.ColorID
    FROM Flowers f
    LEFT JOIN Colors c1 ON (c1.ColorID = f.ColorID) AND (c1.ColorID >= 1)
...
def test_1(act: Action, capsys):
    ...
    expected_out_6x = f"""
        ...
        ............-> Filter
        ................-> Table "PUBLIC"."COLORS" as "C1" Access By ID
        ....................-> Bitmap
        ........................-> Index "PUBLIC"."PK_COLORS" Unique Scan
        ........-> Filter
        ............-> Table "PUBLIC"."COLORS" as "C2" Access By ID
        ................-> Bitmap
        ....................-> Index "PUBLIC"."PK_COLORS" Unique Scan
        {data_list[0]}
    """
