#coding:utf-8
#
# id:           functional.arno.optimizer.opt_sort_by_index_14
# title:        ORDER BY ASC NULLS FIRST using index
# decription:   ORDER BY X ASC NULLS FIRST
#               When a index can be used for sorting, use it.
# tracker_id:   
# min_versions: []
# versions:     2.0
# qmid:         functional.arno.optimizer.opt_sort_by_index_14
...
def test_opt_sort_by_index_14_1(act_1: Action):
