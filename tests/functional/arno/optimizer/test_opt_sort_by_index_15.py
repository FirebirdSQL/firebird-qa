#coding:utf-8
#
# id:           functional.arno.optimizer.opt_sort_by_index_15
# title:        ORDER BY ASC NULLS LAST using index
# decription:   ORDER BY X ASC NULLS LAST
#               When a index can be used for sorting, use it.
# tracker_id:   
# min_versions: []
# versions:     3.0
# qmid:         functional.arno.optimizer.opt_sort_by_index_15
...
def test_opt_sort_by_index_15_1(act_1: Action):
