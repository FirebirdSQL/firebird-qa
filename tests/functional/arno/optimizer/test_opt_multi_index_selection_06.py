...
def test_1(act: Action, capsys):
    ...
    expected_out_4x = f"""
        ...
        ............-> Bitmap
        ................-> Index "I_F3_F2_ASC" Range Scan (lower bound: 2/2, upper bound: 1/2)
        {data_list[0]}
    """
    ...
    expected_out_5x = f"""
        ...
        ........-> Table "SELECTIONTEST" as "ST" Access By ID
        ............-> Bitmap
        ................-> Index "I_F3_F1_ASC" Range Scan (lower bound: 2/2, upper bound: 2/2)
        {data_list[0]}
    """
    ...
    expected_out_6x = f"""
        ...
        ............-> Bitmap
        ................-> Index "PUBLIC"."I_F3_F1_ASC" Range Scan (lower bound: 2/2, upper bound: 2/2)
        {data_list[0]}
    """
