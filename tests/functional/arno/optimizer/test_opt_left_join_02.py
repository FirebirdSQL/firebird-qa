#coding:utf-8
#
# id:           functional.arno.optimizer.opt_left_join_02
# title:        LEFT OUTER JOIN with no match and IS NULL in WHERE clause
...
# min_versions: []
# versions:     2.0
# qmid:         functional.arno.optimizer.opt_left_join_02
...
def test_opt_left_join_02_1(act_1: Action):
