...
# decription:   Integral test for comparison latin-1 characters with diacritical marks and their ascii-equivalents, all kinds of string matching
# tracker_id:   CORE-4599
# min_versions: ['2.5.3']
# versions:     2.5.3
# qmid:         
...
def test_core_4599_1(act_1: Action):
