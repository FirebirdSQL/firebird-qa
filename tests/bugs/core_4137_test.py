...
expected_stdout_6x = """
    ...
    SET TERM ^ ;
    /* Stored procedures headers */
    CREATE OR ALTER PROCEDURE TEST (P01 CHAR(10) CHARACTER SET ISO8859_1 COLLATE PT_BR)
    RETURNS (O01 VARCHAR(30) CHARACTER SET ISO8859_1 COLLATE PT_BR)
    AS
    BEGIN EXIT; END ^
    SET TERM ; ^
    COMMIT WORK;
    ...
    SET TERM ^ ;
    /* Stored procedures bodies */
    ALTER PROCEDURE TEST (P01 CHAR(10) CHARACTER SET ISO8859_1 COLLATE PT_BR)
    RETURNS (O01 VARCHAR(30) CHARACTER SET ISO8859_1 COLLATE PT_BR)
    AS
    begin
    exit;
